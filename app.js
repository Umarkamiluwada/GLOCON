...
function verifiedBadge(prof) {
  ...
  return ' <svg class="verified-badge" viewBox="0 0 22 22" width="15" height="15" title="Verified"><path fill="#1d9bf0" d="M11 0c-.6 0-1.1.3-1.5.7L8.1 2.2 6 2c-.8-.1-1.6.4-1.9 1.1L3.2 5 1.1 6.1C.4 6.5 0 7.2 0 8s.4 1.5 1.1 1.9L3.2 11l.9 1.9c.3.7 1.1 1.2 1.9 1.1l2.1-.2 1.4 1.5c.4.4.9.7 1.5.7s1.1-.3 1.5-.7l1.4-1.5 2.1.2c.8.1 1.6-.4 1.9-1.1l.9-1.9 2.1-1.1c.7-.4 1.1-1.1 1.1-1.9s-.4-1.5-1.1-1.9L18.8 6l-.9-1.9c-.3-.7-1.1-1.2-1.9-1.1l-2.1.2-1.4-1.5C12.1.3 11.6 0 11 0z"/><path fill="#fff" d="M9.6 14.4 5.8 10.6l1.4-1.4 2.4 2.4 5.2-5.2 1.4 1.4z"/></svg>';
}
